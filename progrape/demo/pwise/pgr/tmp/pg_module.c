...
// PGPG Floating-Point Unsigned Subtractor 
// by N.Nakasato (2004/08/23) 
...
// ----------------------------------------------------------- : No. 7
// PGPG Floating-Point FixAccumulator
...
pg_float_fixaccum_26_16_57_64(LONG x, LONG * z)
{
    ...
    pg_fix_accum_f57_s64(fx, &sx);
    *z = sx;
}

// ----------------------------------------------------------- : No. 8
/*
 * PGPG Floating-Point to Fixed-Point Format Converter 
 */
/*
