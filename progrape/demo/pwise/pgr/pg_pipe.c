...
force(double x[][3], double m[], double eps2, double a[][3], int n)
{
	 ...
	 * CONVERT(xi_0,fix) 
	 */ xi_0 =
	    ((int) (x[i][0] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
	    0xFFFFFFFF;
	/*
	 * CONVERT(xi_1,fix) 
	 */ xi_1 =
	    ((int) (x[i][1] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
	    0xFFFFFFFF;
	/*
	 * CONVERT(xi_2,fix) 
	 */ xi_2 =
	    ((int) (x[i][2] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
	    0xFFFFFFFF;
	/*
	 * CONVERT(ieps2,log) 
	 */ if (eps2 == 0.0) {
	...
	for (j = n - 1; j >= 0; j--) {
	     ...
	     * CONVERT(xj_0,fix) 
	     */ xj_0 =
		((int) (x[j][0] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
		0xFFFFFFFF;
	    /*
	     * CONVERT(xj_1,fix) 
	     */ xj_1 =
		((int) (x[j][1] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
		0xFFFFFFFF;
	    /*
	     * CONVERT(xj_2,fix) 
	     */ xj_2 =
		((int) (x[j][2] * (pow(2.0, (double) 32) / (2.0)) + 0.5)) &
		0xFFFFFFFF;
	    /*
	     * CONVERT(mj,log) 
	     */ if (m[j] == 0.0) {
