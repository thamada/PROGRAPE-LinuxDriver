...
// The original source : package/src/vi/pg_util.c
// 2005/06/11:   xx = (double *)&hi;         ->  xx = (double *)(void*)&hi;          by T.H
// 2005/06/11:   LONG _i_ = *((LONG *)(&a)); ->  LONG _i_ = *((LONG *)(void*)(&a));  by T.H
...
/* --- NO ROUNDING(Truncation) VERSION --- */
