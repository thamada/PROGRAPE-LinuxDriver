...
entity ifpga is
  ...
  -- PCI ports; do not modify names!
   ...
   -- PFPGA CONFIG
    ...
    CFG_PROG_B0   : out  std_logic;           -- PFPGA0向けPROG_B
    CFG_PROG_B1   : out  std_logic;           -- PFPGA1向けPROG_B
    CFG_PROG_B2   : out  std_logic;           -- PFPGA2向けPROG_B
    CFG_PROG_B3   : out  std_logic;           -- PFPGA3向けPROG_B
    CFG_CS_B0     : out  std_logic;           -- PFPGA0向けCS_B
    CFG_CS_B1     : out  std_logic;           -- PFPGA1向けCS_B
    CFG_CS_B2     : out  std_logic;           -- PFPGA2向けCS_B
    CFG_CS_B3     : out  std_logic;           -- PFPGA3向けCS_B
    CFG_RDWR_B    : out  std_logic;           -- RD/WR_B
    CFG_INIT_B0   : in  std_logic;     -- PFPGA0向けINIT_B
    CFG_INIT_B1   : in  std_logic;     -- PFPGA1向けINIT_B
    CFG_INIT_B2   : in  std_logic;     -- PFPGA2向けINIT_B
    CFG_INIT_B3   : in  std_logic;     -- PFPGA3向けINIT_B
...
--  generic map (NBIT_L_ADRO => 2) -- for G5 (FDIM=4) # ジェネリックの伝播がうまくいかないので直接local_read_cnt.vhdのI_NFIを変更しましょう!!
  port map (
