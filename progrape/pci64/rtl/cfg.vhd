...
--------------------------------------------------------------
  ...
  -- BAR1
  cfg_int(37)             <= ENABLE ;
  cfg_int(69 downto 38)   <= SIZE16M ; -- now 4MB ( TARGET_AD,DMA_ADRS of (21 downto 0)) is used : 2005/01/19
  cfg_int(70)             <= NOFETCH ;
...
--  cfg_int(223 downto 216) <= X"FF" ;
  cfg_int(231 downto 224) <= X"0F" ;   -- 2004/12/09 by T.H. 
  cfg_int(223 downto 216) <= X"0F" ;   -- 2004/12/09 by T.H. 
